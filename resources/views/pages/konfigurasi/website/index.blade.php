						...
						<div class="panel-group" id="accordionslider" style="margin-top:5px;">
							<div class="table-responsive">
								<table class="table table-bordered table-hover table-striped">
									<thead>
										<tr>
											<th class="col-md-6 text-center">Thumbnail</th>
											<th class="col-md-4 text-center" colspan="2">Tanggal Tampil</th>
										    ...
										    {!! Form::open(['url' => route('config.website.update', $dt['id']), 'method' => 'PATCH']) !!}
												<tr>
													...
													<td class="text-center">
														{!! Form::text('started_at', $dt['started_at'], [
																		'class'        		=> 'date-time-format form-control', 
															]) !!}
													</td>
													<td class="text-center">
														{!! Form::text('ended_at', $dt['ended_at'], [
																		'class'        		=> 'date-time-format form-control', 
															]) !!}
													</td>
													<td class="text-center">
