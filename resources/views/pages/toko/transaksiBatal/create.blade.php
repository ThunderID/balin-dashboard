...
<!-- body -->
    ...
    {!! Form::open(['url' => route('admin.cancelorder.update', $data['data']['id']), 'method' => 'PATCH']) !!}
    @else
    {!! Form::open(['url' => route('admin.cancelorder.store'), 'method' => 'POST']) !!}
    @endif
		<div class="row">
			<div class="col-md-12">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group text-right">
					<a href="{{ URL::route('admin.cancelorder.index') }}" class="btn btn-md btn-default" tabindex="13">Batal</a>
